...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <div class="container">
            <a class="navbar-brand fw-bold" href="{{ url('/') }}">
                <i class="bi bi-building me-2"></i>{{ config('app.name', 'Company') }}
            </a>
    ...
    <footer class="bg-dark text-light pt-5 pb-3">
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-4">
                    <h5 class="fw-bold mb-3"><i class="bi bi-building me-2"></i>{{ config('app.name', 'Company') }}</h5>
                    <p class="text-secondary small">Building innovative solutions for tomorrow's challenges. We are dedicated to delivering excellence in every project we undertake.</p>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    <ul class="list-unstyled small text-secondary">
                        ...
                        <li class="mb-2"><i class="bi bi-envelope me-2"></i>info@company.com</li>
            ...
            <p class="text-center text-secondary small mb-0">&copy; {{ date('Y') }} {{ config('app.name', 'Company') }}. All rights reserved.</p>
        </div>
    </footer>
